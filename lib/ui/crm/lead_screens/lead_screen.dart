                                          ...
                                          Column(
                                            ...
                                            children: [
                                              SizedBox(
                                                  ...
                                                  child: NormalText(fontWeight: FontWeight.w500, color: COLORS.black, fontSize:2, text: "Contact Name : Maheshkumara M P")),
                                              cardSubText(title: "Enquiry",subTitle: "Franchise Inquiry",width: 0.6),
                                              cardSubText(title: "Lead Name",subTitle: "M kumara",width: 0.6),
                                              cardSubText(title: "Status",subTitle: "Exclusive Store",width: 0.6),
                                              cardSubText(title: "Prospect Status",subTitle: "Hot Lead-Exclusive Store",width: 0.6),
                                            ],
                                          ),
                                          Column(
