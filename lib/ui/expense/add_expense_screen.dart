...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  List<String> productList=["example1"];
              ...
              child: Column(
                ...
                children: [
                 ...
                 const InputFieldTitleText(text: "Reporting Place *"),
                          ...
                          SizedBox(
                            ...
                            child:NormalTextFormField(
                                ...
                                validator: (value){
                                  if(value==null||value.isEmpty)
                                  {
                                    return "Claim Quantity is Empty";
                                  }
                                  return null;
                                },
                                readOnly: false
                  ...
                  SizedBox(height: SizeConfig.blockHeight*2,),
                  NormalButton(title: "ADD", onTap: (){}, height: SizeConfig.blockHeight*7, width: SizeConfig.screenWidth)
